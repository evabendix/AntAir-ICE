def conv_MODIS(file):
	...
	sys.path.insert(0, "/Applic.HPC/Easybuild/skylake/2020a/software/SciPy-bundle/2020.03-foss-2020a-Python-3.8.2/lib/python3.8/site-packages")
	...
	# Target dataset
	dataset_name = 'Ice_Surface_Temperature'

	# Open HDF file
	hdffn = file
	#print(hdffn)
	#hdffn = 'MOD29P1D.A2010001.h15v08.061.2021148173232.hdf'
	...
	#proj4str =("+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 +a=6371228 +b=6371228 +units=m +no_defs")
	#proj4str =("+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 +R=6371228 +units=m +no_defs")
	#proj4str =("+proj=laea +lat_0=-5156620156.17741 +lon_0=0 +x_0=0 +y_0=0 +R=6371228 +units=m +no_defs +type=crs")
	#proj4str =("+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs")
	...
	#outdsSRS = osr.SpatialReference()
	#outdsSRS.ImportFromEPSG(4326)
	#outds.SetProjection(outdsSRS.ExportToWkt())
	#outRasterSRS = osr.SpatialReference()
	#outRasterSRS.ImportFromEPSG(3031)
